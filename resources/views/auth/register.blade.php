                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" id="name" type="text" name="name" required="" value="{{ old('name') }}" placeholder="Name">
                                    </div>
                                </div>

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" id="username" type="text" name="username" required="" value="{{ old('username') }}" placeholder="UserName">
                                    </div>
                                </div>
